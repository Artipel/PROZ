...
public class Task2b {
    ...
    public static void main(String[] args) {
        ...
        final int sampleSize = 30, numberOfEpochs = 600;
        ...
        settings[0] = new Settings(inputSize, new int[]{4}, outputSize, bias, computingFX, outputFX, 0.1, 0.1);
        settings[1] = new Settings(inputSize, new int[]{4}, outputSize, bias, computingFX, outputFX, 0.1, 0.5);
        settings[2] = new Settings(inputSize, new int[]{4}, outputSize, bias, computingFX, outputFX,  0.5, 0.1);
        settings[3] = new Settings(inputSize, new int[]{4}, outputSize, bias, computingFX, outputFX,  0.5, 0.5);
        ...
        FileManager.saveGraph1(errors, deviations, settings, outputFilename, 5.0);
        FileManager.saveGraph1(testErrors, testDeviations, settings, outputFilename + "TEST",5.0);
